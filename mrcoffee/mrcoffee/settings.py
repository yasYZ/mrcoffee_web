"""
Django settings for mrcoffee project.
...
SECRET_KEY = 'django-insecure-(+9xq#s=-8+836$72&qo%n_2=8*=tlv^xt89494cmda7mlczg!'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'sold_product.context_processors.cart',
            ],
        },
    },
]

WSGI_APPLICATION = 'mrcoffee.wsgi.application'
